...
class NewsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        News::create(['title_fr_new'=>'Succès de la saison 2022. "L\'Avare" de Benoît Lambert repris à la Comédie de Saint-Etienne avant de partir en tournée',
        ...
        News::create(['title_fr_new'=>'Le Danemark succède à la France et remporte le Bocuse d\'Or 2023',
        ...
        News::create(['title_fr_new'=>'BALISAGE : Devenez baliseur bénévole de la FFRandonée',
